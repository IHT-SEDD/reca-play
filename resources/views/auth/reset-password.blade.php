<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-input-error-email :messages="$errors->first('email')" class="mt-2" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-input-error-email :messages="$errors->first('password')" class="mt-2" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-input-error-email :messages="$errors->first('password_confirmation')" class="mt-2" />
        </div>
