<x-app-layout :pageTitle="'Venue Management'">
 <div class="w-full mx-auto">
  ...
  <div class="mb-4 w-full flex lg:flex-row flex-col justify-between lg:items-center md:items-center items-start">
   ...
   <h1 class="lg:text-3xl md:text-2xl text-xl font-bold text-color-default" id="venue_name"></h1>
  </div>
  <!-- Text Header :end -->
  ...
  <div class="w-full flex items-center justify-start gap-1.5 lg:mb-4 md:mb-3 mb-2">
   <h3 class="lg:text-xl md:text-lg text-md tracking-wider font-bold text-color-default">
    Statistics
   </h3>
  ...
  <!-- Text sub header :begin -->
  <h3 class="lg:text-xl md:text-lg text-md tracking-wider font-bold text-color-default lg:mb-4 md:mb-3 mb-2">
   Field List
  </h3>
  <!-- Text sub header :end -->
