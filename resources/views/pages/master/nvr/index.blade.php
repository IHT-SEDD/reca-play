<x-app-layout :pageTitle="'Master NVR'">
 <div class="w-full mx-auto">
  <!-- Text Header :begin -->
  <h1 class=" md:text-4xl text-2xl font-bold text-hot-shot w-full mb-4">Master NVR</h1>
  <!-- Text Header :end -->

  <div class="w-full flex flex-col lg:flex-row justify-between items-start gap-4">
   @include('pages.master.nvr.partial.nvr-list')
   @include('pages.master.nvr.partial.add-form')
  </div>
 </div>

  @include('pages.master.nvr.partial.edit-form')
 ...
 <script src="{{ asset('assets/js/master/nvr.js') }}"></script>
 @endpush
</x-app-layout>
