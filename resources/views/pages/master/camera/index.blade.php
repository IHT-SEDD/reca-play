<x-app-layout :pageTitle="'Master Camera'">
 <div class="w-full mx-auto">
  <!-- Text Header :begin -->
  <h1 class=" md:text-4xl text-2xl font-bold text-hot-shot w-full mb-4">Master Camera</h1>
  <!-- Text Header :end -->

  <div class="w-full flex flex-col lg:flex-row justify-between items-start gap-4">
   @include('pages.master.camera.partial.camera-list')
   @include('pages.master.camera.partial.add-form')
  </div>
 </div>

 @include('pages.master.camera.partial.edit-form')
 ...
 <script src="{{ asset('assets/js/master/camera.js') }}"></script>
 @endpush
</x-app-layout>
