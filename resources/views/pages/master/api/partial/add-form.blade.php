...
@section('content')
<form method="POST" action="{{ url('/master/api/add-data') }}" class="ajax-form" data-datatable="#api-table"
 novalidate>
 @csrf
 <div>
 ...
 <div class="mt-2">
  ...
  <x-inputs.text-input id="url" class="block mt-2 w-full" type="text" name="url"
   :value="old('url')" required placeholder="New api url" autocomplete="off" />
 ...
 <div class="mt-2">
  ...
  <x-inputs.text-input id="username" class="block mt-2 w-full" type="text" name="username"
   :value="old('username')" required placeholder="New api username" autocomplete="off" />
  <x-input-error id="input-username-error"></x-input-error>
 </div>

 <div class="mt-2">
  <x-input-label for="password" :value="__('Password')" />
  <x-inputs.text-input id="password" class="block mt-2 w-full" type="text" name="password"
   :value="old('password')" required placeholder="New api password" autocomplete="off" />
