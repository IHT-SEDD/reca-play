<x-app-layout :pageTitle="'Master QR Code'">
 <div class="py-8">
  <div class="w-full mx-auto md:px-8 px-5">
   <!-- Text Header :begin -->
   <h1 class=" md:text-4xl text-2xl font-bold text-hot-shot w-full mb-4">Master QR Code</h1>
   <!-- Text Header :end -->

   <div class="w-full flex flex-col lg:flex-row justify-between items-start gap-4">
    @include('pages.master.qr_code.partial.qr_code-list')
    @include('pages.master.qr_code.partial.add-form')
   </div>
  </div>
 </div>
 ...
 <script src="{{ asset('assets/js/master/qr_code.js') }}"></script>
 @endpush
</x-app-layout>