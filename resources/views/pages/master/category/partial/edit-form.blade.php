...
@section('edit-title')
<h1 class=" md:text-xl text-md font-bold text-hot-shot w-full">Edit category</h1>
@endsection

@section('edit-content')
<form method="PUT" action="{{ url('/master/category/update-data') }}" id="edit-form" class="ajax-edit-form"
  data-datatable="#category-table" novalidate>
  @csrf
  @method('PUT')
